...
export const NODES: CurriculumNode[] = [
  ...
  {
    id: 'A1', branch: 'A', title: 'Mark Making & Line Control', tier: 1, prereqs: [],
  ...
  {
    id: 'A2', branch: 'A', title: 'Basic Perspective & the Box', tier: 1, prereqs: all('A1'),
  ...
  {
    id: 'A3', branch: 'A', title: 'Form & Construction (3D Primitives)', tier: 2, prereqs: all('A2'),
  ...
  {
    id: 'A4', branch: 'A', title: 'Value, Light & Shadow', tier: 2, prereqs: all('A3'),
  ...
  {
    id: 'A5', branch: 'A', title: 'Color Theory', tier: 3, prereqs: all('A4'),
  ...
  {
    id: 'A6', branch: 'A', title: 'Composition & Design', tier: 3, prereqs: all('A4'),
  ...
  {
    id: 'B1', branch: 'B', title: 'Software Setup & Navigation', tier: 0, prereqs: [],
  ...
  {
    id: 'B2', branch: 'B', title: 'Brushes, Layers & Blending', tier: 1, prereqs: all('B1'),
  ...
  {
    id: 'B3', branch: 'B', title: 'Tablet Control & Digital Line Confidence', tier: 1, prereqs: all('A1', 'B2'),
  ...
  {
    id: 'B4', branch: 'B', title: 'Digital Painting & Rendering Workflow', tier: 4, prereqs: all('A4', 'A5', 'B2'),
  ...
  {
    id: 'C1', branch: 'C', title: 'Gesture Drawing', tier: 2, prereqs: all('A1'),
  ...
  {
    id: 'C2', branch: 'C', title: 'Figure Construction & Proportion', tier: 3, prereqs: all('C1', 'A3'),
  ...
  {
    id: 'C3', branch: 'C', title: 'Head, Face & Expression', tier: 3, prereqs: all('C2'),
  ...
  {
    id: 'C4', branch: 'C', title: 'Hands, Feet & Extremities', tier: 3, prereqs: all('C2'),
  ...
  {
    id: 'C5', branch: 'C', title: 'Muscular & Skeletal Anatomy', tier: 4, prereqs: all('C2'),
  ...
  {
    id: 'C6', branch: 'C', title: 'Complete Adult Anatomy', tier: 4, prereqs: all('C5'), mature: true,
  ...
  {
    id: 'C7', branch: 'C', title: 'Dynamic Action Poses & Foreshortening', tier: 5, prereqs: all('C5', 'A2'),
  ...
  {
    id: 'C8', branch: 'C', title: 'Figure Interaction (Two+ Figures)', tier: 5, prereqs: all('C6', 'C7'), mature: true,
  ...
  {
    id: 'C9', branch: 'C', title: 'Gore, Wounds & Damaged Anatomy', tier: 5, prereqs: all('C5'), mature: true,
  ...
  {
    id: 'D1', branch: 'D', title: 'Shape Language & Silhouette', tier: 4, prereqs: all('C2', 'A6'),
  ...
  {
    id: 'D2', branch: 'D', title: 'Costume, Props & Material Design', tier: 4, prereqs: all('D1', 'A4'),
  ...
  {
    id: 'D3', branch: 'D', title: 'Style Development & Stylization', tier: 5, prereqs: all('D1', 'C3'),
  ...
  {
    id: 'D4', branch: 'D', title: 'Turnarounds & Model Sheets', tier: 5, prereqs: all('D2'),
  ...
  {
    id: 'E1', branch: 'E', title: 'Animal Anatomy & Construction', tier: 4, prereqs: all('C1', 'A3'),
  ...
  {
    id: 'E2', branch: 'E', title: 'Furry / Anthro Characters', tier: 5, prereqs: all('E1', 'C2', 'D1'),
  ...
  {
    id: 'E3', branch: 'E', title: 'Monsters & Aliens', tier: 5, prereqs: all('E1', 'C5', 'D1'),
  ...
  {
    id: 'E4', branch: 'E', title: 'Robots, Mechs & Hard Surface', tier: 5, prereqs: all('A2', 'D1'),
  ...
  {
    id: 'F1', branch: 'F', title: 'Environment Perspective & Depth', tier: 4, prereqs: all('A2', 'A6'),
  ...
  {
    id: 'F2', branch: 'F', title: 'Natural Forms: Rocks & Terrain', tier: 5, prereqs: all('F1', 'A4'),
  ...
  {
    id: 'F3', branch: 'F', title: 'Foliage, Trees & Forests', tier: 5, prereqs: all('F1', 'A4'),
  ...
  {
    id: 'F4', branch: 'F', title: 'Water, Waves & Reflections', tier: 5, prereqs: all('F1', 'A4'),
  ...
  {
    id: 'F5', branch: 'F', title: 'Skies, Clouds & Atmosphere', tier: 5, prereqs: all('F1', 'A5'),
  ...
  {
    id: 'F6', branch: 'F', title: 'Machines, Vehicles & Architecture', tier: 5, prereqs: all('F1', 'E4'),
  ...
  {
    id: 'F7', branch: 'F', title: 'Scene Composition & Environment Illustration', tier: 6, prereqs: all('F2', 'F3', 'F4', 'F5', 'A6'),
  ...
  {
    id: 'G1', branch: 'G', title: 'Character Illustration (Finished)', tier: 6, prereqs: all('C5', 'D2', 'B4'),
  ...
  {
    id: 'G2', branch: 'G', title: 'Creature / Mech Hero Illustration', tier: 6,
  ...
  {
    id: 'G3', branch: 'G', title: 'Dynamic Multi-Figure Action Scene', tier: 6, prereqs: all('C8', 'C7', 'F7'),
  ...
  {
    id: 'G4', branch: 'G', title: 'Mature Scene Composition (Capstone)', tier: 6, prereqs: all('C6', 'C8', 'C9', 'A6'), mature: true,
  ...
  {
    id: 'G5', branch: 'G', title: 'Portfolio & Personal Style', tier: 6,
